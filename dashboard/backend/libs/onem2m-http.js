(function() {
  ...
  exports = module.exports = {
    ...
    CreateResourceXML: CreateResourceXML,
  ...
  function CreateResource(parentResourceUrl, resource, origin) {
    ...
    return new Promise(function(resolved, rejected) {
      ...
      Http(options)
        ...
        .catch(function(error) {
          debug( 'fail to create resource ', error.message );
          rejected(error);
        });
    });
  }
  ...
  function CreateResourceXML(parentResourceUrl, resource, resourceTypeCode, origin) {
    ...
    return new Promise(function(resolved, rejected) {
      ...
      var options = {
        ...
        headers: {
          ...
          "Content-Type": "application/vnd.onem2m-res+xml;ty="+resourceTypeCode,
          "X-M2M-RI": Uuid.v4(),
          "X-M2M-Origin": origin
        },
        body: resource
  ...
  function UpdateResource(resourceUrl, resource, origin) {
    ...
    return new Promise(function(resolved, rejected) {
      ...
      Http(options)
        ...
        .catch(function(error) {
          debug( 'fail to update resource ', error.message );
          rejected(error);
        });
    });
  }
